<?php $__env->startSection('title', 'เล่นเกม Python'); ?>
...
<div style="margin-bottom:14px">
    ...
    <p style="color:var(--muted);font-size:14px;margin-top:4px">สวัสดี <strong style="color:var(--ink)"><?php echo e($user->name); ?></strong> — เล่นเกมแล้วคะแนนจะถูกบันทึกอัตโนมัติ!</p>
</div>
...
<div class="game-frame-wrap">
    <iframe
        id="gameFrame"
        src="<?php echo e(asset('game_assets/python-game.html')); ?>"
        height="760"
...
window.addEventListener('message', async function(event) {
    ...
    try {
        const res = await fetch('<?php echo e(route('game.score.save')); ?>', {
            method: 'POST',
            headers: {
        ...
        if (data.success) {
            ...
            if (payload.levels_completed >= 6) {
                setTimeout(() => {
                    window.location.href = '<?php echo e(route('game.complete')); ?>';
                }, 2000);
            }
        }
    } catch (err) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/fnwin/Documents/Code/laravel-python-game/resources/views/game/index.blade.php ENDPATH**/ ?>