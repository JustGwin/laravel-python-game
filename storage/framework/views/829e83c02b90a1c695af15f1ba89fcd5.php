...
<div class="login-container">
    ...
    <div class="login-card">
        ...
        <div id="tab-quick" class="tab-content active">
            <form method="POST" action="<?php echo e(route('quick.play')); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        value="<?php echo e(old('room_code')); ?>"
                        maxlength="6"
                        required
...
<?php /**PATH /home/fnwin/Documents/Code/laravel-python-game/resources/views/auth/login.blade.php ENDPATH**/ ?>