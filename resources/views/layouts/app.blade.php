...
<head>
    ...
    <title>@yield('title', 'Python Game') | Python Beginner Game</title>
...
<!-- ─── Navbar ─────────────────────────────────────────────────────────── -->
<nav class="navbar">
    <a class="nav-brand" href="{{ auth()->user()?->isAdmin() ? route('admin.dashboard') : route('game.index') }}">
    ...
    <div class="nav-right">
        @auth
            @if(auth()->user()->isAdmin())
                <a href="{{ route('admin.dashboard') }}" class="btn btn-ghost btn-sm"><i class="fa-solid fa-chart-line"></i> Dashboard</a>
                <a href="{{ route('admin.rooms.index') }}" class="btn btn-ghost btn-sm"><i class="fa-solid fa-door-open"></i> ห้องเรียน</a>
            @else
                <a href="{{ route('game.index') }}" class="btn btn-ghost btn-sm"><i class="fa-solid fa-gamepad"></i> เกม</a>
                <a href="{{ route('game.history') }}" class="btn btn-ghost btn-sm"><i class="fa-solid fa-clock-rotate-left"></i> ประวัติ</a>
            @endif
            <span class="nav-user">
                สวัสดี <strong>{{ auth()->user()->name }}</strong>
            </span>
            <span class="badge-role {{ auth()->user()->role }}"><i class="fa-solid fa-user-shield"></i> {{ auth()->user()->role }}</span>
